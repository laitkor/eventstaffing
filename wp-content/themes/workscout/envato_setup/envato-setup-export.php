		...
		foreach ( $meta as $meta_key => $meta_val ) {
			if (
				...
				(
					...
					strpos( $meta_key, 'reneva_page_layout' ) === false &&
					strpos( $meta_key, 'reneva_titlebar' ) === false &&
					strpos( $meta_key, 'reneva_subtitle' ) === false &&
					...
					! in_array( $meta_key, array(
						...
						'reneva_titlebar',
						'reneva_subtitle',
						'reneva_parallax_image',
						'reneva_parallax_color',
						'reneva_parallax_opacity',
						'reneva_sidebar_select',
						'reneva_revslider',
						'reneva_project_date',
						'reneva_project_location',
						'reneva_gallery_type',
						'reneva_team_position',
						'reneva_gallery',
						'reneva_service_description',
						'reneva_service_icon',
						'_wp_attached_file',
						'_thumbnail_id',
					) )
