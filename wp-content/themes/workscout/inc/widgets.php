...
class workscout_tabbed extends WP_Widget {  
    ...
    function widget($args, $instance) {
        ...
        <ul class="tabs-nav blog">
            <?php if(!empty($recent) ) { ?><li class="active"><a class="recentPost" href="#tab1" title="Recent Posts"><?php echo wp_kses($recenttitle,$allowed_tags); ?></a></li><?php } ?>
            <?php if(!empty($popular) ) { ?><li><a class="popularPost" href="#tab2" title="Popular Posts"><?php echo wp_kses($populartitle,$allowed_tags); ?></a></li><?php } ?>
        ...
        <div class="tab-content" id="tab2">
            <!-- Popular Posts -->
            <ul class="widget-tabs">
               <?php the_widget( 'WP_Widget_Archives' ); //echo self::showLatest($posts = $number, $orderby = "comment_count"); ?>
           </ul>
       </div>
       <?php } ?>
