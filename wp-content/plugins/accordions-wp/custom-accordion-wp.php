<?php
	...
	***************************************/
	...
	function tp_accordions_frees_options_framework() {
		...
		<div class="wrap about-wrap">
			<h1>Welcome to Accordion - V2.1</h1>
			...
			<div class="feature-section two-col">
				...
				<div class="col">
					<ul>
						...
						<li><span class="dashicons dashicons-yes"></span> 8+ different Themes.</li>
				...
				<div class="col">
					<ul>
						...
						<li><span class="dashicons dashicons-yes"></span> Show/Hide Accordions expand/collapse icons options.</li>
						<li><span class="dashicons dashicons-yes"></span> Accordion header closeAble true or false Options.</li>
			...
			<h2>
				<a href="http://themepoints.com/product/wp-accordions-pro/" class="button button-primary button-hero" target="_blank">Buy Premium Version Only $8</a>
			</h2>
			<br>
			<br>
			<br>
	...
	***************************************/
	...
	function themepoints_custom_accordion_submenu_pages() {
		add_submenu_page( 'edit.php?post_type=accordion_tp', __('Support', 'tcaccordion'), __('Support', 'tcaccordion'), 'manage_options', 'support', 'themepoints_custom_accordion_support_callback' );		
	}
